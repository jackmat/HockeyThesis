...
#    Season = 2007
        ...
        MultiplyingMat = IndexByTeamSeason(Season,d,c, False)
        print("Multiplying Matrix created")
        ...
        #(1) Val/sec = Dividing ValueMat/TimeMat
        ValbySec =[]
        for i in range(len(PlayerTimePlayer)):
            ValbySec.append(PlayerValueMat[i].fillna(0)/PlayerTimePlayer[i].fillna(0)*MultiplyingMat[i].fillna(0)*60)
        ...
        ValbySecMat = JoinListpdMatrices(ValbySec)       
