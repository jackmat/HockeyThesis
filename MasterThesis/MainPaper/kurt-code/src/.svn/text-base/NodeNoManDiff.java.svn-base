...
public class NodeNoManDiff
{
	...
	private ArrayList<NodeNoManDiff> children;
	private ArrayList<ArrayList<Integer>> timeUntilNextEvent;
	private NodeNoManDiff parent;
	...
	public NodeNoManDiff()
	{
		this.visited = false;
		this.count = 0;
		this.children = new ArrayList<NodeNoManDiff>();
		this.gameCount = 0;
		this.homeWinCount = 0;
		this.awayWinCount = 0;
	}
...
//	}
	...
	public NodeNoManDiff FindChildNode( NodeNoManDiff node )
	{
		for ( NodeNoManDiff child : this.children )
		{
	...
	public void SetParent( NodeNoManDiff node )
	{
		this.parent = node;
	}
	
	public void AddChild( NodeNoManDiff node )
	{
		this.children.add( node );
		node.SetParent( this );
	}
	
	public boolean CompareNode( NodeNoManDiff node )
	{
...
//		}
	...
	public void PrintNode( int level )
	{
		...
		for ( NodeNoManDiff child : children )
		{
